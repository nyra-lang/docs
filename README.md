...
Applied documentation — apps, HTTP, OS APIs, integration patterns.

| Page | Topic |
|------|-------|
| `examples.html` | Example applications index |
| `dungeon-steps.html` | Reference app walkthrough |
| `backend.html` | Backend & HTTP overview |
